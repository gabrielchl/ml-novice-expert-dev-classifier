...
dataset = read_csv('datahawk2.csv', names=[
    'lines', 'empty_lines', 'line_comment', 'block_comment',
    'javadoc_comment', 'variables', 'variables_len_avg', 'if', 'for', 'do',
    'while', 'cast', 'complexity',
    'num_method', 'avg_cyclo', 'hbugs', 'class_size', 'CBO', 'num_comment_line',
    'review_factor', 'inheritance_tree_depth', 'specialization_retio',
    'cohesion', 'max_cyclo', 'num_query_method', 'num_superclass',
    'num_subclass', 'command', 'hlen', 'method_no_cohesion', 'statements',
    'heffort', 'total_response', 'maintainability', 'num_code', 'fan_in',
    'maintainability_no_comment', 'reuse_ratio', 'LCOM2', 'hvol', 'fan_out',
    'SIX', 'total_cyclo', 'MPC', 'num_comment', 'label'
])
